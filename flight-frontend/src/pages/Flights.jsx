...
function Flights() {
  ...
  const askLoginBeforeBooking = () => {
    alert("Please Register or Login first to book a flight");
  };
        ...
        <div className="container">
          ...
          <div className="text-center text-white mb-5">
            ...
            <p className="lead mb-0">
              Select your route, choose your seat, and book with confidence.
            </p>
          </div>
